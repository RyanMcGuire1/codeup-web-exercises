...
var favoriteFoods = ["pizza", "cheese burgers", "ice cream"];
...
//console.log("The length of instructer is: " + instructors.length);
...
// we kn ow we have to get the length of array -1
//==> array.length - 1
